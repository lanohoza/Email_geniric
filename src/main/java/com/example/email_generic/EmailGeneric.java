...
public  class EmailGeneric {
 ...
 static String VendeurDahaB = "Hello nom , <br/> You have a new order for delivery with number num_commande <br/>" +
 ...
 static String AcheteurDomicile = "Hello nom ,<br/>" +
 ...
 //-----------point de livraison-------------------
 static String AcheteurPoint = "Hello nom ,<br/>" +
         "your purchase is confirmed with the following delivery information: <br/>" +
         ...
         "Delivery time: Delai days <br/>";
 //-------------------Chez le vendeur-----------------------
 static String AcheteurChezVendeur = "Hello nom ,<br/>" +
         "your purchase is confirmed with the following delivery information: <br/>" +
 ...
 static String VendeurVirementReserv = "Hello nom ,<br/>" + "You have a new order with order N° num_commande <br/>" +
 ...
 static String AcheteurVirRes = "Hello nom ,<br/>" + "Your reservation request expires after: Delai days, and if the seller rejects the reservation, or if the reservation deadline has passed without confirmation from the seller, your reservation will be automatically canceled.";
 //------------------------------------------------Réservation confirmer par vendeur -------------------------------------------------//
 static String subject5 = "Reservation acceptance N° num_commande";
 static String AcheteurVirConfirmReserv = "Hello nom ,<br/>" +
 ...
 static String AcheteurVirRefuReserv = "Hello nom ,<br/>" + "With all my regrets, your reservation is canceled.";
 //------------------------------------------Délai expiré(Annulation de commande) --------------------------------------------//
 //Vendeur
 //subject6
 static String VendeurRevCancel = "Hello nom ,<br/>" +
         "Order number num_commande has been cancelled,because the payment deadline has expired with payment not made.";
 //Acheteur
 //subject6
 static String AcheteurVirDelaiExpir = "Hello nom ,<br/>" +
 ...
 static String VendeurVirPay = "Hello nom ,<br/>" + "Payment has been made for order number num_commande, payment and delivery receipt attached below." +
 ...
 static String AcheteurVirPay = "Hello nom ,<br/>" + "Your purchase with num_commande is waiting for the seller to verify the validity of the payment receipt.<br/>" +
 ...
 static String AcheteurNValidRecu = "Hello nom ,<br/>" +
 ...
 // subject=sbject2
 static String ITInfinityMsg = "Hello ITInfinity,<br/>" + "The request payment reseved with order N°" + "num_commande " + "is confirmed.";
 //------------------------------------------------Pour Acheteur & ITInfinity(Echec de transaction)-------------------------------------------------//
 static String subject10 = "Failed transaction for num_commande";

 static String AcheteurechecTransaction = "Hello nom ,<br/>" + "You have a failure in your payment transaction, please retry.";
 static String ITInfinityMsgNo = "Hello ITInfinity,<br/>" + "There is a failure in the payment transaction for order number num_commande .";



 public static Mail email(String from, String to, String subject, String text, String num_commande,String nom, List<String> files, String willaya, String commune, String code_postal, String num_rue, String Téléphone, String mail, String link_GPS, String point_livraison, String Delai, String Frais_transport, String lien_confirm, String lien_cancel, String num_compte, String lien_banque) throws IOException {

  Email From = new Email(from);
  Email To = new Email(to);
  Content content;
  content = new Content("text/html", text.replaceFirst(
          "num_commande", num_commande).replaceFirst("nom",nom).replaceFirst(
